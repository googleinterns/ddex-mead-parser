...
public class MeadConverter {
  ...
  public Message convert(String xmlString) throws MeadConversionException {
    try {
      ...
      Document document =
          DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(xmlInputSource);
  ...
  private void mergeRoot(Document document, Message.Builder messageBuilder)
      throws MeadConversionException {
